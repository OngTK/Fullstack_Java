    ...
    public static void main(String[] args) {
        ...
        for(;;){                                                                //무한루프
            ...
            if(choice == 1){                                                    // 선택 1
                ...
                Waiting waiting = new Waiting();                                // Waiting class를 기반으로하는 waiting변수 선언
                waiting.call = call;                                            // waiting 변수에 call 값 대입
                waiting.count = count;                                          // waiting 변수에 count 값 대입
                
                boolean check = false;                                          // 저장여부 : ture 작성완료 / false 작성불가
                ...
                for(int i = 0 ; i < waitings.length ; i++){
                    if(waitings[i] != null) {
                        System.out.printf("%d. 연락처: %s - 인원: %d명\n",i+1,waitings[i].call,waitings[i].count);
                        System.out.println("------------------------------------");
                    } // if end
                } // 선택 2일때 for end
            } // if 사용자 선택 end
