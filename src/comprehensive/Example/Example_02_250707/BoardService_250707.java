package comprehensive.Example_02_250707;
...
//        [경고] 게시물을 등록할 공간이 부족합니다.
        ...
        for (; ; ) {
            ...
            if (choice == 1) {
                System.out.print("내용 :");
                String contentInput = scan.next();
                System.out.print("작성자 :");
                String writerInput = scan.next();

                boolean check = false; // true-글쓰기 성공, false 경고

                for (int i = 0; i < contents.length; i++) {
                    if (contents[i] == null) {
                        contents[i] = contentInput;
                        writers[i] = writerInput;
                        check = true;
                        break;
                    }
                }
